...
# Load model (BART base) (CHANGE THIS)
model = AutoModelForSeq2SeqLM.from_pretrained("./bart-base").to("cuda") # Using CPU but if GPU add .to("cuda")
...
tracker = CarbonTracker(epochs=num_epochs, components="gpu", monitor_epochs = -1, log_dir = "./carbon-results-bart")
...
model.save_pretrained("./bart-base-trained")
tokenizer.save_pretrained("./bart-base-trained")
