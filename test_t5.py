...
model = AutoModelForSeq2SeqLM.from_pretrained("./t5-base-trained").to("cuda") # Using CPU but if GPU add .to("cuda")
tokenizer = AutoTokenizer.from_pretrained("./t5-base-trained") 
